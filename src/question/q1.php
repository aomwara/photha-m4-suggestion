...
<body>
    ...
    if ($data) {
        ...
        if ($data['score1'] != 0 && $data['score2'] != 0 && $data['score3'] != 0 && $data['score4'] != 0 && $data['score5'] != 0) {
            echo '<hr>
            <h4>ความสนใจในแผนการเรียนวิทยาศาสตร์ คณิตศาสตร์</h4>
              <h5>ได้คะแนนรวม ' . $data['score1'] . ' คะแนน </h5>
              <h4>ความสนใจในแผนการเรียนคณิตศาสตร์ ภาษาอังกฤษ</h4>
              <h5>ได้คะแนนรวม ' . $data['score2'] . ' คะแนน </h5>
              <h4>ความสนใจในแผนการเรียนภาษาอังกฤษ และภาษาต่างประเทศที่ 2 </h4>
              <h5>ได้คะแนนรวม ' . $data['score3'] . ' คะแนน </h5>
              <h4>ความสนใจในแผนการเรียนศิลป์ ทั่วไป</h4>
              <h5>ได้คะแนนรวม ' . $data['score4'] . ' คะแนน </h5>
              <h4>ความสนใจในสายอาชีพ</h4>
              <h5>ได้คะแนนรวม ' . $data['score5'] . ' คะแนน </h5>
            ';
        }
        exit();
    }
