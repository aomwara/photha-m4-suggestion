...
<td><b><font size="4" color="#020A35" >แบบทดสอบการสำรวจตนเอง</font></b></td>
 ...
 <table align="right">
          ...
          <font color = #0f125f> 37. มีความรู้พื้นฐานในการใช้ภาษา ฟัง พูด อ่าน เขียน ทั้งภาษาไทยและภาษาอังกฤษ ? </font><br><br>
      ...
      <font color = #0f125f> 42. มีมนุษย์สัมพันธ์ดี สนุกกับการทำงานที่ต้องเกี่ยวข้องพบปะกับผู้อื่นเสมอ ? </font><br><br>
      ...
      <font color = #0f125f> 46. คล่องแคล่ว กล้าแสดงความคิดเห็น และนำเสนอได้อย่างสร้างสรรค์ ? </font><br><br>
      ...
      <br>
                ...
                &nbsp; &nbsp; <button type="button" onclick="window.location.href='q5.php'"> ไปแบบทดสอบถัดไป </button>
...
<?php
if (isset($_POST['question37'],$_POST['question38'],$_POST['question39'],$_POST['question40']
,$_POST['question41'],$_POST['question42'],$_POST['question43'],$_POST['question44'],$_POST['question45']
,$_POST['question46'],$_POST['question47'],$_POST['question48']  )) 
    {
      ...
      $stmt = $conn->prepare("INSERT INTO tbl_assessment(score4)VALUES(:score4)");
